...
* Explain:
** show LOGIN system
** database migration for dummies
** error checking done so far
...
** or 0 or ''
* Upload
** Monthly changes (FIDE rating)
** https://trumpexcel.com/extract-data-from-drop-down-list/
* Problems:
** For now the bulk update feature doesnt allow update of member registered events
* Tests:
** Password
#+begin_quote
