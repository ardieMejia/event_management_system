...
* Convince payment:
** each testing now literally takes 2wice as long, becoz I have to test everything form, form subgroups, and answers
** from your end, the form looks like stakcking elements. But from my end, its getting more abstract. Coz its "elements creating elements". And on top of that, theres subgroups requiring more logic behind the scenes
** basically, my brain has to work overtime.
* Some limitations:
