...
** show error of "no form for this event"
** full blown question flow like National Youth Chess Championship 2024, also include checks of spaces in subgroup fieldname, and missing subgroup fieldname
** show the upload folder structure created (path nameand filename), especially when uploading 2 files
** show that repeated file uploads dont clash, thanks to date
* Some limitations:
