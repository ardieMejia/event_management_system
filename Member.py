...
def ID_generator(data, used_id, name, contact_number, email_address, event_id):
    global Global.temporary_members_value
    ...
    Global.temporary_members_value.update({'MEMBER ID': id_generator})
    return id_generator
...
# Menu Delete
def Delete_data(data, event_data):
    global members_path
        ...
        if main_menu_input == '1':      # Menu Read
            ...
            while True:
                ...
                if sub_menu_2_input == '1':     # Add new member
                    Input_data_member(data= members_data, used_id= used_members_ID, evt= event_data , value= Global.temporary_members_value)
